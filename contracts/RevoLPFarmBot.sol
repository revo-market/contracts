...
/**
 * RevoUniswapFarmBot is an abstract class suitable for use when implementing a RevoFarmBot atop of
 ...
 * In particular, this applies to both Sushiswap and Ubeswap.
 **/
abstract contract RevoUniswapStakingTokenStrategy is RevoFarmBot {
	...
	(uint256 _amountToken0, uint256 _amountToken1) = UniswapRouter.swapTokensForEqualAmounts(
						swapRouter,
